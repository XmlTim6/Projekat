...
public class ReviewFormController {
    ...
    public ResponseEntity<String> getReviewForm(
        ...
        Long userId = AuthHelper.getCurrentUserId();
        ReviewForm reviewForm = reviewFormService.findReviewForm(submissionId, revision, document, userId);
        return new ResponseEntity<>(XMLMarshaller.createStringFromReviewForm(reviewForm), HttpStatus.OK);
    }
